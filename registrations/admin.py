...
class UserRegistrationAdmin(ModelAdmin):
    list_display = ('name', 'email', 'registration_type', 'payment_status', 'final_price', 'referral_code_used')
    list_filter = ('registration_type', 'payment_status', IsPccoEFilter, 'referral_code_used')
    search_fields = ('name', 'email', 'phone', 'college', 'org_name')
